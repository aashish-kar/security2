  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg w-[27rem] max-w-lg flex flex-col items-center">
        <h2 className="text-3xl font-medium text-center text-gray-800 mb-2">Sign Up</h2>
        <p className="text-sm text-gray-500 text-center mb-6">Create an account to start your food journey.</p>
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col items-center">
          <div className="mb-4 w-full flex space-x-4">
            <div className="w-1/2">
              ...
              <input
                ...
                className="w-full text-black p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00bf63]"
          ...
          <div className="mb-4 w-full flex justify-center items-center">
            ...
            <label htmlFor="terms" className="text-sm text-gray-500 text-center">
              I agree to the{" "}
              <a href="#" className="text-[#00bf63] hover:underline">
