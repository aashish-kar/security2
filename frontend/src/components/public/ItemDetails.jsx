...
const ItemDetails = () => { 
    ...
    return (
        <><Layout /><div className="bg-gray-100 py-20 px-4">
            <div className="max-w-6xl mx-auto rounded-lg shadow border border-gray-200 bg-white grid grid-cols-1 md:grid-cols-2 gap-10 p-8">
                ...
                <div className="relative">
                    <img
                        ...
                        alt={item.name} />
                    <button className={`absolute top-3 right-3 bg-white p-2 rounded-full shadow hover:bg-gray-200 ${isWishlisted ? "text-red-500" : "text-black"}`} onClick={toggleWishlist}>
                        <FaHeart size={20} />
                    </button>
                </div>
                ...
                <div className="flex flex-col justify-center space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex items-center border border-gray-300 rounded-lg bg-gray-50">
                                <button
                                    className="bg-gray-200 text-gray-800 px-4 py-2 rounded-l-lg hover:bg-gray-300 font-bold text-lg"
                                    onClick={() => handleQuantityChange("decrease")}
                                >
                                    -
                                </button>
                                <span className="w-16 h-10 flex items-center justify-center text-lg font-medium bg-white border-x border-gray-300">
                                    {quantity}
                                </span>
                                <button
                                    className="bg-gray-200 text-gray-800 px-4 py-2 rounded-r-lg hover:bg-gray-300 font-bold text-lg"
                    ...
                    <div className="pt-4">
                        <button 
                            className="bg-blue-600 text-white font-medium px-8 py-3 rounded-lg hover:bg-blue-700 w-full md:w-auto" 
                            onClick={addToCart}
                        >
                            Add to Cart
                        </button>
