...
const Home = lazy(() =>
  import("./components/public/Home.jsx").then((module) => {
    console.log("Home module:", module);
    return module;
  })
);
const OtpVerification = lazy(() =>
  import("./components/public/OtpVerification.jsx").then((module) => {
    console.log("OtpVerification module:", module);
    return module;
  })
);
const Login = lazy(() =>
  import("./components/public/login.jsx").then((module) => {
    console.log("Login module:", module);
    return module;
  })
);
const ForgotPassword = lazy(() =>
  import("./components/public/ForgotPassword.jsx").then((module) => {
    console.log("ForgotPassword module:", module);
    return module;
  })
);
const ResetPassword = lazy(() =>
  import("./components/public/ResetPassword.jsx").then((module) => {
    console.log("ResetPassword module:", module);
    return module;
  })
);
const Register = lazy(() =>
  import("./components/public/register.jsx").then((module) => {
    console.log("Register module:", module);
    return module;
  })
);
const Layout = lazy(() =>
  import("./components/private/Index.jsx").then((module) => {
    console.log("Layout module:", module);
    return module;
  })
);
const ContactUs = lazy(() =>
  import("./components/public/ContactUs.jsx").then((module) => {
    console.log("ContactUs module:", module);
    return module;
  })
);
const PrivacyPolicy = lazy(() =>
  import("./components/public/PrivacyPolicy.jsx").then((module) => {
    console.log("PrivacyPolicy module:", module);
    return module;
  })
);
const About = lazy(() =>
  import("./components/public/About.jsx").then((module) => {
    console.log("About module:", module);
    return module;
  })
);
const TermsCondition = lazy(() =>
  import("./components/public/TermsCondition.jsx").then((module) => {
    console.log("TermsCondition module:", module);
    return module;
  })
);
const RefundPolicy = lazy(() =>
  import("./components/public/RefundPolicy.jsx").then((module) => {
    console.log("RefundPolicy module:", module);
    return module;
  })
);
const CancellationPolicy = lazy(() =>
  import("./components/public/CancellationPolicy.jsx").then((module) => {
    console.log("CancellationPolicy module:", module);
    return module;
  })
);
const DeliveryCharges = lazy(() =>
  import("./components/public/DeliveryCharges.jsx").then((module) => {
    console.log("DeliveryCharges module:", module);
    return module;
  })
);
const Dashboard = lazy(() =>
  import("./components/private/dashboard/Index.jsx").then((module) => {
...
const AllCategory = lazy(() =>
  import("./components/private/category/Index.jsx").then((module) => {
    console.log("AllCategory module:", module);
    return module;
  })
);
const EditCategory = lazy(() =>
  import("./components/private/category/EditCategory.jsx").then((module) => {
    console.log("EditCategory module:", module);
    return module;
  })
);
const EditSubcategory = lazy(() =>
  import("./components/private/subcategory/EditSubcategory.jsx").then((module) => {
    console.log("EditSubcategory module:", module);
    return module;
  })
);
const EditItem = lazy(() =>
  import("./components/private/item/EditItem.jsx").then((module) => {
    console.log("EditItem module:", module);
    return module;
  })
);
const AddCategory = lazy(() =>
  import("./components/private/category/Form.jsx").then((module) => {
    console.log("AddCategory module:", module);
    return module;
  })
);
const AddSubcategory = lazy(() =>
  import("./components/private/subcategory/Form.jsx").then((module) => {
    console.log("AddSubcategory module:", module);
    return module;
  })
);
const AllSubcategory = lazy(() =>
  import("./components/private/subcategory/Index.jsx").then((module) => {
    console.log("AllSubcategory module:", module);
    return module;
  })
);
const User = lazy(() =>
  import("./components/private/user/Index.jsx").then((module) => {
    console.log("User module:", module);
    return module;
  })
);
const AddItem = lazy(() =>
  import("./components/private/item/Form.jsx").then((module) => {
    console.log("AddItem module:", module);
    return module;
  })
);
const ViewItem = lazy(() =>
  import("./components/private/item/Index.jsx").then((module) => {
    console.log("ViewItem module:", module);
    return module;
  })
);
const CancelOrder = lazy(() =>
  import("./components/private/order/CancelOrder.jsx").then((module) => {
    console.log("CancelOrder module:", module);
    return module;
  })
);
const CompletedOrder = lazy(() =>
  import("./components/private/order/CompletedOrder.jsx").then((module) => {
    console.log("CompletedOrder module:", module);
    return module;
  })
);
const ConfirmOrder = lazy(() =>
  import("./components/public/ItemDetails.jsx").then((module) => {
    console.log("ConfirmOrder module:", module);
    return module;
  })
);
const PendingOrder = lazy(() =>
  import("./components/private/order/PendingOrder.jsx").then((module) => {
    console.log("PendingOrder module:", module);
    return module;
  })
);
const ProcessingOrder = lazy(() =>
  import("./components/private/order/ProcessingOrder.jsx").then((module) => {
    console.log("ProcessingOrder module:", module);
    return module;
  })
);
const Settings = lazy(() =>
  import("./components/private/user/Form.jsx").then((module) => {
    console.log("Settings module:", module);
    return module;
  })
);
const AllOrder = lazy(() =>
  import("./components/private/order/Index.jsx").then((module) => {
    console.log("AllOrder module:", module);
    return module;
  })
);
const Support = lazy(() =>
  import("./components/private/user/Support.jsx").then((module) => {
...
const Profile = lazy(() =>
  import("./components/public/Profile.jsx").then((module) => {
    console.log("Profile module:", module);
    return module;
  })
);
const MyOrders = lazy(() =>
  import("./components/public/MyOrders.jsx").then((module) => {
    console.log("MyOrders module:", module);
    return module;
  })
);
const Cart = lazy(() =>
  import("./components/public/Cart.jsx").then((module) => {
    console.log("Cart module:", module);
    return module;
  })
);
const Wishlist = lazy(() =>
  import("./components/public/Wishlist.jsx").then((module) => {
    console.log("Wishlist module:", module);
    return module;
  })
);
const Checkout = lazy(() =>
  import("./components/public/Checkout.jsx").then((module) => {
    console.log("Checkout module:", module);
    return module;
  })
);
const Menu = lazy(() =>
  import("./components/public/Menu.jsx").then((module) => {
    console.log("Menu module:", module);
    return module;
  })
);
const OrderSuccess = lazy(() =>
  import("./components/public/OrderSuccess.jsx").then((module) => {
    console.log("OrderSuccess module:", module);
    return module;
  })
);
const SearchResults = lazy(() =>
  import("./components/public/SearchResults.jsx").then((module) => {
